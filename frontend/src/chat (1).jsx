...
function ChatInboxView({ token, onBack, onOpenConversation, background = NEUTRAL_HERO_GRADIENT }) {
  ...
  return (
    <div className="min-h-dvh transition-[background] duration-500" style={{ background }}>
